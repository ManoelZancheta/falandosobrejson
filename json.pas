...
begin
   ...
   try
      ...
      //Criação do Array de Dependentes
      arrDependentes := TJSONArray.Create;

      //Criação do Primeiro Objeto Dependente
      ...
      //Criação do Segundo Objeto Dependente
      jsonDependentes := TJSONObject.Create;
...
begin
   ...
   try
      ...
      //Adicionando o Objeto Funcionário ao Array de Funcionários
...
begin
   ...
   for i:= 0 to pred(arrFuncionarios.Count) do
      begin
        ...
        memo4.Lines.Add('Salário: '  + arrFuncionarios.Get(i).GetValue<double>('salario', 0).ToString);
        memo4.Lines.Add('Férias ?: ' + arrFuncionarios.Get(i).GetValue<string>('ferias'));
